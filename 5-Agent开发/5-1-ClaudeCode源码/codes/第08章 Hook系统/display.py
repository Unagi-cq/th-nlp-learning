...
def permission_denied(tool_name: str, reason: str):
    print(f"{SP}[DENIED] {tool_name}: {reason}")


def permission_user_denied(tool_name: str):
    print(f"{SP}[USER DENIED] {tool_name}")
